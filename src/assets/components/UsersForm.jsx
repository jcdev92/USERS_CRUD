...
const UsersForm = ({getAllUsers, setUpdateUsers, updateUsers, handleModalOff}) => {
  ...
  return (
    <form className="form" onSubmit={handleSubmit(submit)}>
      ...
      <button className={updateUsers? "form__btn form__btn__upt" : "form__btn"} onClick={() => handleModalOff()}>{updateUsers ? <MdChangeCircle className="form__btn__add"/>: <AiFillPlusCircle className="form__btn__add"/> }</button>
    </form>
  );
};
